...
def every_city_salary(df):
    ...
    bar_chart.render(path="../各城市平均薪资柱形图.html")
...
def every_district_salary(df):
    ...
    bar_chart_district.render(path="../各市区平均薪资柱形图.html")
# 计算每个具体地点的平均薪资
...
# 增加的推荐系统方法，融入了一些机器学习元素，并根据薪资统计信息挑选公司
